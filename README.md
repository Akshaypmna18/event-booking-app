...
- **Comprehensive Testing** - Vitest with Testing Library for unit and integration tests
...
- Tailwind CSS for styling with class utilities
- Zustand stores for state management
- React Router for navigation between pages
- Radix UI components for accessible UI patterns

## Development Workflow

1. **Development**: Run `npm run dev` to start the local development server
2. **Testing**: Write tests alongside your components and run `npm run test`
3. **Linting**: Keep code quality high with `npm run lint`
4. **Building**: Create a production build with `npm run build`
